...
sound1 = pygame.mixer.Sound(r"/SoundBoard/soundEffects/Voice1.mp3")
sound2 = pygame.mixer.Sound(r"/SoundBoard/soundEffects/Voice2.mp3")
sound3 = pygame.mixer.Sound(r"/SoundBoard/soundEffects/Voice3.mp3")
sound4 = pygame.mixer.Sound(r"/SoundBoard/soundEffects/Voice4.mp3")
sound5 = pygame.mixer.Sound(r"/SoundBoard/soundEffects/Voice4.mp3")
sound6 = pygame.mixer.Sound(r"/SoundBoard/soundEffects/voice6.mp3")
sound7 = pygame.mixer.Sound(r"/SoundBoard/soundEffects/voice7.mp3")
sound8 = pygame.mixer.Sound(r"/SoundBoard/soundEffects/voice8.mp3")
run = True
